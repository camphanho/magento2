...
class Edit extends \Camph\Faq\Controller\Adminhtml\Faq
{
    
    private $resultPageFactory;
    
    /**
     * @var \Camph\Faq\Model\Faq
     */
    private $faqModel;
     ...
     * @param \Camph\Faq\Model\Faq $faqModel
     */
    ...
    public function execute()
    {
        ...
        $this->coreRegistry->register('camph_faq_faq', $model);
